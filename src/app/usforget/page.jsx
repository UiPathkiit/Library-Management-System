    ...
    <div className="flex flex-col lg:flex-row h-screen w-full bg-[#E4FBFF]">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-10">
        ...
        <div className="bg-[#E6F9E6] p-6 lg:p-10 rounded-2xl border-[#ACD3BE] border-4 shadow-lg w-full max-w-md">
          <h2 className="text-2xl lg:text-3xl tracking-wide font-semibold text-center mb-4">Forget Password</h2>
          ...
          />
          <Link href="/uotp" className="w-full bg-black text-white p-3 rounded-2xl font-bold hover:opacity-90 text-center block">
            RESET PASSWORD
          </Link>
        </div>
      </div>
